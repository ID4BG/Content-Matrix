    ...
    <div className="space-y-12">
      <div>
        ...
        <p className="text-muted-foreground">
          Overview of your content matrix.
        </p>
      </div>
                  ...
                  <Card className="hover:border-black transition-colors cursor-pointer group">
                    <CardContent className="p-5">
                      <div className="flex justify-between items-start mb-2">
                        <h3 className="font-semibold group-hover:underline decoration-2 underline-offset-4">
                          {campaign.title}
                        </h3>
                        <Badge
                          variant="outline"
                      ...
                      <div className="flex items-center text-xs text-muted-foreground gap-4">
                        ...
                        <span>
                          Updated{" "}
                          {format(new Date(campaign.updatedAt), "MMM d")}
                        </span>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="hover:border-black transition-colors cursor-pointer group">
                    <CardContent className="p-4 flex items-center justify-between">
                      ...
                      <Badge variant="secondary">
                        {folder.campaignCount} Campaigns
                      </Badge>
                    </CardContent>
                  </Card>
                </Link>
              ...
              <div className="divide-y">
                {isLoadingActivity ? (
                  ...
                  (activity ?? []).slice(0, 10).map((item) => (
                    <div
                      key={item.id}
                      className="p-4 flex gap-4 items-start hover:bg-secondary/30 transition-colors"
                    >
